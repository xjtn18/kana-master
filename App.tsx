...
function App() {
  ...
  const [completionStats, setCompletionStats] = useState<{ completed: number; total: number }>({ completed: 0, total: 0 });
  ...
  const handleComplete = (gameResults: QuestionResult[], total: number, completed: number) => {
